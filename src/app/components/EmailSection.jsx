...
const EmailSection = () => {
  ...
  return (
    <section id="contact" className="py-20 px-6 text-center">
      ...
      <p className="mb-6">Feel free to reach out if you’d like to collaborate or just say hello.</p>
      <a href="mailto:your.email@example.com" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-xl transition">Contact Me</a>
    </section>
